...
import com.cfets.test.heartbeat.HeartBeatImpl;
...
public class MinaClient {
    public static void main(String[] args) throws InterruptedException {
        ...
        //------拦截器处理链中加入心跳开始----------
        KeepAliveFilter keepAliveFilter = new KeepAliveFilter(new HeartBeatImpl(), IdleStatus.READER_IDLE, KeepAliveRequestTimeoutHandler.CLOSE);//实例化一个 KeepAliveFilter 过滤器
        ...
        keepAliveFilter.setRequestTimeout(1);//设置心跳包请求后 等待反馈超时时间。 超过该时间后则调用KeepAliveRequestTimeoutHandler.CLOSE
